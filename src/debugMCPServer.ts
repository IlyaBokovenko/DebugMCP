    ...
    private setupTools() {
        ...
        this.server.addTool({
            ...
            parameters: z.object({
                ...
                configurationName: z.string().optional().describe('Name of the debug configuration from launch.json to use. If not specified, the first configuration will be used automatically.'),
            }),

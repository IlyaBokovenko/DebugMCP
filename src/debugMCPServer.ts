 ...
 * 
 * This server is backend-agnostic - it works with any IDebugBackend implementation:
 * - VSCodeDebugBackend for VS Code extension mode
 * - StandaloneDAPBackend for standalone CLI mode (Phase 3)
 */
